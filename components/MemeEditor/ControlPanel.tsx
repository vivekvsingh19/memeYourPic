...
const ControlPanel: React.FC<ControlPanelProps> = ({
  ...
  const [activeColorPicker, setActiveColorPicker] = useState<'fill' | 'outline' | 'canvas' | null>(null);
  ...
  const handleCloseColorPicker = () => {
    ...
    if (activeColorPicker === 'canvas') {
        ...
        colorToSave = activeColorPicker === 'fill' ? (selectedLayer.color || '') : (selectedLayer.strokeColor || '');
    }
  ...
  const toggleColorPicker = (type: 'fill' | 'outline' | 'canvas') => {
